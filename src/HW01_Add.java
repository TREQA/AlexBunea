...
Acest program va fi asemănător cu programul din exemplul precedent:

public class Add { public static void main(String[] args) { /*metoda println()tipăreşte întregul număr la ieşire şi trece în rând nou
